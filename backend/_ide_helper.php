 ...
 * Generated for Laravel 5.7.13 on 2018-11-17 23:01:47.
 *
...
namespace Auth0\Login\Facade { 
    ...
    class Auth0 {
        ...
        public static function logout()
        {
            return \Auth0\Login\Auth0Service::logout();
        }
         ...
         * @static 
         */ 
        public static function login($connection = null, $state = null, $additional_params = array(), $response_type = 'code')
        {
            return \Auth0\Login\Auth0Service::login($connection, $state, $additional_params, $response_type);
        }
        ...
        public static function getUser()
        {
            return \Auth0\Login\Auth0Service::getUser();
        }
         ...
         * @static 
         */ 
        public static function onLogin($cb)
        {
            return \Auth0\Login\Auth0Service::onLogin($cb);
        }
         ...
         * @static 
         */ 
        public static function hasOnLogin()
        {
            return \Auth0\Login\Auth0Service::hasOnLogin();
        }
         ...
         * @static 
         */ 
        public static function callOnLogin($auth0User)
        {
            return \Auth0\Login\Auth0Service::callOnLogin($auth0User);
        }
         ...
         * @static 
         */ 
        public static function rememberUser($value = null)
        {
            return \Auth0\Login\Auth0Service::rememberUser($value);
        }
         ...
         * @static 
         */ 
        public static function decodeJWT($encUser)
        {
            return \Auth0\Login\Auth0Service::decodeJWT($encUser);
        }
        ...
        {
            return \Auth0\Login\Auth0Service::getIdToken();
        }
        ...
        {
            return \Auth0\Login\Auth0Service::getAccessToken();
        }
         ...
         * @static 
         */ 
        public static function jwtuser()
        {
            return \Auth0\Login\Auth0Service::jwtuser();
        }
...
namespace  { 
    ...
    class Auth0 extends \Auth0\Login\Facade\Auth0 {}
